...
export const CONTRATACAO_COPY: Record<Locale, Copy> = {
  pt: {
    ui: {
      ...
      dialogue: [
        { who: "Marcia", text: "Sinceramente? Achei o preço bem salgado." },
        { who: "Júlia", text: "Entendo. E quanto custa hoje deixar como está?" },
        { who: "Marcia", text: "Hm… nunca parei pra calcular. Me mostra isso." },
      ],
    },
  ...
  en: {
    ui: {
      ...
      dialogue: [
        { who: "Marcia", text: "Honestly? The price feels really steep." },
        { who: "Júlia", text: "I hear you. What does leaving it as is cost you today?" },
        { who: "Marcia", text: "Hm… I never stopped to do that math. Show me." },
      ],
    },
  ...
  es: {
    ui: {
      ...
      dialogue: [
        { who: "Marcia", text: "¿Sinceramente? El precio me parece muy alto." },
        { who: "Júlia", text: "Te entiendo. ¿Y cuánto te cuesta hoy dejarlo así?" },
        { who: "Marcia", text: "Hm… nunca me puse a calcularlo. Muéstramelo." },
      ],
    },
