      ...
      <div className="py-12 md:py-32">
        ...
        <div className="flex flex-col lg:flex-row items-center gap-8 md:gap-12 lg:gap-16 relative">
          ...
          <div className="flex-1 max-w-lg -translate-y-[15px]">
            ...
            <p className="text-sm md:text-base text-text-secondary leading-relaxed">
              <span className="md:hidden">Seu vendedor treina com um cliente virtual por voz. Cenários configuráveis, avaliação SPIN automática.</span>
              <span className="hidden md:inline">O vendedor pratica conversas de vendas com um cliente virtual gerado por inteligência artificial. O cenário e configurável,idade, temperamento, persona do comprador, objeções específicas,e a conversa acontece por voz, com transcrição automática.</span>
            </p>
        ...
        <div id="nicole" className="flex flex-col lg:flex-row items-start gap-8 md:gap-12 lg:gap-16 relative mt-6 md:mt-8 lg:ml-[3vw] xl:ml-[4vw]">
          ...
          <div className="flex-1 max-w-lg lg:pt-32">
            ...
            <p className="text-sm md:text-lg text-text-secondary leading-relaxed">
              <span className="md:hidden">IA que acompanha performance, organiza agenda e analisa reuniões do seu time em tempo real.</span>
              <span className="hidden md:inline">A Nicole é a assistente de IA da Ramppy. Ela acompanha a performance de cada vendedor, organiza a agenda, analisa reuniões e sugere os próximos passos, tudo em tempo real, direto na plataforma.</span>
            </p>
        ...
        <div className="flex flex-col lg:flex-row items-center gap-8 md:gap-12 lg:gap-16 relative mt-6 md:mt-8">
          ...
          <div className="flex-1 max-w-lg">
            ...
            <p className="text-sm md:text-base text-text-secondary leading-relaxed">
              <span className="md:hidden">Bot entra nas reuniões do Meet, transcreve e avalia com SPIN Selling. Sem instalar nada.</span>
              <span className="hidden md:inline">Conecte seu Google Agenda e pronto. Um bot entra automáticamente em cada reunião do Google Meet, transcreve tudo e aplica a mesma avaliação SPIN Selling usada nas simulações. Sem instalar nada, sem configurar nada.</span>
            </p>
            <p className="hidden md:block text-base text-text-secondary leading-relaxed mt-6">
