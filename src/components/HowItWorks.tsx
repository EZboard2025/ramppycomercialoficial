...
const strings = {
  pt: {
    badge: "Implementação",
    titleA: "A gente implementa ",
    titleB: "com você",
    subtitle: "Você não fica sozinho. Nosso time te acompanha do primeiro acesso até os primeiros resultados.",
    steps: [
      {
        number: "01",
  ...
  en: {
    ...
    titleA: "We roll it out ",
    titleB: "with you",
    subtitle: "You're not on your own. Our team supports you from the first login to the first results.",
    steps: [
      {
        number: "01",
        title: "Discovery call",
        description: "We learn your team's current reality — processes, challenges and goals — so we can tailor the platform to you.",
      },
      {
        number: "02",
        title: "Assisted setup",
        description: "Our team configures personas, scenarios and objections alongside you. Your reps start training with the right context from day one.",
      },
      {
        number: "03",
        title: "Team onboarding",
        description: "We train your reps and managers on the platform. Everyone is productive from the very first day.",
      },
      {
        number: "04",
        title: "Ongoing partnership",
        description: "Our team keeps tracking results with you, tunes scenarios and makes sure the platform evolves with your team.",
      },
    ],
  },
};
      ...
      <div className="py-20 md:py-32">
        ...
        <div className="text-center max-w-2xl mx-auto mb-10 md:mb-20">
          ...
          <h2 className="font-[var(--font-fustat)] text-2xl md:text-[32px] lg:text-[48px] font-semibold leading-[110%] tracking-[-0.04em] text-teal-dark">
            {t.titleA}
            <span className="text-primary-green">{t.titleB}</span>
          </h2>
