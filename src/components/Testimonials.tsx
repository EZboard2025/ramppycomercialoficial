...
const testimonials = [
  ...
  },
  {
    ...
    text: "A análise automática de Meet economiza 3 horas por semana do meu time. O feedback é extremamente preciso e me ajuda a fazer coaching direcionado.",
    metric: "3h",
  ...
  },
  {
    ...
    text: "A análise da Ramppy me dá feedback preciso depois de cada call. Minha nota subiu de 5.2 para 8.4 em um mês. Nunca mais perdi uma objeção importante.",
    metric: "5.2 → 8.4",
    metricLabel: "Nota Ramppy",
    stars: 5,
  },
];
