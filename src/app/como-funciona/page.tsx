...
const steps = [
  {
    ...
    video: "/videos/Configuração Gestor.mp4",
    reverse: false,
  },
  {
    badge: "Passo 02",
    ...
    video: "/videos/Configuração Sessão Simulação.mp4",
    reverse: true,
  },
  {
    badge: "Passo 03",
  ...
  },
  {
    ...
    video: "/videos/dashboard de gestão.mp4",
    reverse: false,
  },
  {
    badge: "Passo 06",
        ...
        <SectionWrapper key={idx} id={`passo-${String(idx + 1).padStart(2, "0")}`} className={idx === 0 ? "overflow-visible" : ""}>
          <div className={`py-12 md:py-20 ${idx === 0 ? "" : ""}`}>
            <div className={`flex flex-col ${step.reverse ? "lg:flex-row-reverse" : "lg:flex-row"} items-start gap-12 lg:gap-16`}>
              {/* Media */}
              <div className={`flex-1 w-full ${step.video === "/videos/Nicole clip feature.mp4" ? "max-w-[500px]" : ""}`}>
